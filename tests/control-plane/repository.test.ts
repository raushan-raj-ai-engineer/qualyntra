...
function run(id:string,projectId:string,key?:string){return{id,scope:{organizationId:'o1',workspaceId:'w1',projectId},request:{runId:id,projectId,runtime:{language:'typescript',runner:'playwright-test'}},status:'queued' as const,createdAt:'2026-09-17T00:00:00.000Z',updatedAt:'2026-09-17T00:00:00.000Z',version:1,idempotencyKey:key,requestFingerprint:`fp-${id}`};}
