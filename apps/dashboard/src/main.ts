...
import { BootstrapServiceSessionResolver } from './session';
...
const sessionResolver=new BootstrapServiceSessionResolver(process.env.QUALYNTRA_DASHBOARD_BOOTSTRAP_TOKEN,process.env.QUALYNTRA_DASHBOARD_BOOTSTRAP_ACTOR_ID??'dashboard-bootstrap');
const server=createDashboardServer({
  staticRoot:path.resolve(process.cwd(),'dist/apps/dashboard/public'),controlPlaneOrigin,sessionResolver,
