...
export const descriptor:AdapterDescriptor={id:'runner.testng',kind:'runner',version:'1.0.0',displayName:'TestNG',description:'External-process integration for TestNG.',capabilities:["cancellation", "tags", "junit-output"]};
