...
export const descriptor:AdapterDescriptor={id:'runner.junit-console',kind:'runner',version:'1.0.0',displayName:'JUnit Platform Console',description:'External-process integration for JUnit Platform Console.',capabilities:["discovery", "cancellation", "tags", "junit-output"],supportedLanguages:['java'],supportedTools:['junit']};
