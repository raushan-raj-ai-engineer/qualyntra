...
export const descriptor:AdapterDescriptor={id:'runner.cypress',kind:'runner',version:'1.0.0',displayName:'Cypress',description:'External-process integration for Cypress.',capabilities:["cancellation", "tags", "junit-output"],supportedLanguages:['javascript','typescript'],supportedTools:['cypress']};
