...
export const descriptor:AdapterDescriptor={id:'runner.webdriverio',kind:'runner',version:'1.0.0',displayName:'WebdriverIO',description:'External-process integration for WebdriverIO.',capabilities:["cancellation", "sharding", "junit-output"],supportedLanguages:['javascript','typescript'],supportedTools:['webdriverio']};
