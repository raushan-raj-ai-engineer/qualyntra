 ...
 * Author: Raushan Raj
 */
import type { SecretReference } from './governance';
...
export interface ExecutionRequest { runId:string; projectId:string; command?:string; args?:string[]; cwd?:string; env?:Record<string,string>; secretRefs?:Record<string,SecretReference>; selection?:{tests?:string[]; tags?:string[]}; runtime:RuntimeIdentity; metadata?:Record<string,string>; timeoutMs?:number; }
